\hypertarget{bsoc_8c}{}\doxysection{ha\+\_\+energy/bsoc.c File Reference}
\label{bsoc_8c}\index{ha\_energy/bsoc.c@{ha\_energy/bsoc.c}}
...
\begin{DoxyCompactItemize}
\item 
const char $\ast$ \mbox{\hyperlink{bsoc_8c_ae6b57480d8cda466cfc65b9bfc47b255}{mqtt\+\_\+name}} \mbox{[}\mbox{\hyperlink{energy_8h_a4798b70da5e09a128bfc682db0b65072ab183b38bd716ecf9405c4546e3bd6870}{V\+\_\+\+DLAST}}\mbox{]}
\item 
...
\mbox{\Hypertarget{bsoc_8c_af738b354e21276b35d56a42f217ac1f8}\label{bsoc_8c_af738b354e21276b35d56a42f217ac1f8}} 
\index{bsoc.c@{bsoc.c}!ac0\_filter@{ac0\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a4ec0fe226796da34c999530046265c3a}\label{bsoc_8c_a4ec0fe226796da34c999530046265c3a}} 
\index{bsoc.c@{bsoc.c}!ac1\_filter@{ac1\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_aa933af2d3df8ce390f6f95900df4b525}\label{bsoc_8c_aa933af2d3df8ce390f6f95900df4b525}} 
\index{bsoc.c@{bsoc.c}!ac2\_filter@{ac2\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a413c5066cb43aae0039adba36593129a}\label{bsoc_8c_a413c5066cb43aae0039adba36593129a}} 
\index{bsoc.c@{bsoc.c}!ac\_test@{ac\_test}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a4ff1d7778a0780a0f1c029a738322513}\label{bsoc_8c_a4ff1d7778a0780a0f1c029a738322513}} 
\index{bsoc.c@{bsoc.c}!bat\_current\_stable@{bat\_current\_stable}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a63f8e1b6516cda51fd09570aaf4e147d}\label{bsoc_8c_a63f8e1b6516cda51fd09570aaf4e147d}} 
\index{bsoc.c@{bsoc.c}!bsoc\_ac@{bsoc\_ac}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a4c8b6884b4cae5d49a0d4141ce516372}\label{bsoc_8c_a4c8b6884b4cae5d49a0d4141ce516372}} 
\index{bsoc.c@{bsoc.c}!bsoc\_data\_collect@{bsoc\_data\_collect}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_ab9a97f08a9166d16e45b2025c3887eab}\label{bsoc_8c_ab9a97f08a9166d16e45b2025c3887eab}} 
\index{bsoc.c@{bsoc.c}!bsoc\_gti@{bsoc\_gti}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a571a7c60ba1a2a6c569427c21c829733}\label{bsoc_8c_a571a7c60ba1a2a6c569427c21c829733}} 
\index{bsoc.c@{bsoc.c}!bsoc\_init@{bsoc\_init}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a49c1e06b8059a63a9ed7c7d729e59d90}\label{bsoc_8c_a49c1e06b8059a63a9ed7c7d729e59d90}} 
\index{bsoc.c@{bsoc.c}!bsoc\_set\_mode@{bsoc\_set\_mode}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_adc8522b4d922a9ce45f83ca6a8d2708c}\label{bsoc_8c_adc8522b4d922a9ce45f83ca6a8d2708c}} 
\index{bsoc.c@{bsoc.c}!bsoc\_set\_std\_dev@{bsoc\_set\_std\_dev}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a822d408a5e379216cd6a003381f94b43}\label{bsoc_8c_a822d408a5e379216cd6a003381f94b43}} 
\index{bsoc.c@{bsoc.c}!calculateStandardDeviation@{calculateStandardDeviation}}
...
{\footnotesize\ttfamily double calculate\+Standard\+Deviation (\begin{DoxyParamCaption}\item[{const uint32\+\_\+t}]{N,  }\item[{const double}]{data\mbox{[}$\,$\mbox{]} }\end{DoxyParamCaption})}


\begin{DoxyCode}{0}
\DoxyCodeLine{205 \{}
\DoxyCodeLine{206     \textcolor{comment}{// variable to store sum of the given data}}
\DoxyCodeLine{207     \textcolor{keywordtype}{double} sum = 0;}
\DoxyCodeLine{208 }
\DoxyCodeLine{209     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < N; i++) \{}
\DoxyCodeLine{210         sum += data[i];}
\DoxyCodeLine{211     \}}
\DoxyCodeLine{212 }
\DoxyCodeLine{213     \textcolor{comment}{// calculating mean}}
\DoxyCodeLine{214     \textcolor{keywordtype}{double} mean = sum / N;}
\DoxyCodeLine{215 }
\DoxyCodeLine{216     \textcolor{comment}{// temporary variable to store the summation of square}}
\DoxyCodeLine{217     \textcolor{comment}{// of difference between individual data items and mean}}
\DoxyCodeLine{218     \textcolor{keywordtype}{double} values = 0;}
\DoxyCodeLine{219 }
\DoxyCodeLine{220     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < N; i++) \{}
\DoxyCodeLine{221         values += pow(data[i] -\/ mean, 2);}
\DoxyCodeLine{222     \}}
\DoxyCodeLine{223 }
\DoxyCodeLine{224     \textcolor{comment}{// variance is the square of standard deviation}}
\DoxyCodeLine{225     \textcolor{keywordtype}{double} variance = values / N;}
\DoxyCodeLine{226 }
\DoxyCodeLine{227     \textcolor{comment}{// calculating standard deviation by finding square root}}
\DoxyCodeLine{228     \textcolor{comment}{// of variance}}
\DoxyCodeLine{229     \textcolor{keywordtype}{double} standardDeviation = sqrt(variance);}
\DoxyCodeLine{230     \mbox{\hyperlink{bsoc_8c_abde809820d909d15f6f2b063208258ef}{L}}.\mbox{\hyperlink{structlocal__type_a26f83e801170629be93cdef740ac2a55}{batc\_std\_dev}} = standardDeviation;}
\DoxyCodeLine{231 }
\DoxyCodeLine{232 \textcolor{preprocessor}{\#ifdef BSOC\_DEBUG}}
\DoxyCodeLine{233     \textcolor{comment}{// printing standard deviation}}
\DoxyCodeLine{234     fprintf(\mbox{\hyperlink{energy_8c_acec19516a59050bb447192fe318e6a9c}{fout}}, \textcolor{stringliteral}{"{}STD DEV of Current \%.2f\(\backslash\)r\(\backslash\)n"{}}, standardDeviation);}
\DoxyCodeLine{235 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{236     \textcolor{keywordflow}{return} standardDeviation;}
\DoxyCodeLine{237 \}}

\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a017e138f3c81b9dd94af5d7e7bd7616c}\label{bsoc_8c_a017e138f3c81b9dd94af5d7e7bd7616c}} 
\index{bsoc.c@{bsoc.c}!dc0\_filter@{dc0\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a623a5ccd411eeeba8acd1132a33a15e8}\label{bsoc_8c_a623a5ccd411eeeba8acd1132a33a15e8}} 
\index{bsoc.c@{bsoc.c}!dc1\_filter@{dc1\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a4846561257bfbb8d753328d1fe7a1c07}\label{bsoc_8c_a4846561257bfbb8d753328d1fe7a1c07}} 
\index{bsoc.c@{bsoc.c}!dc2\_filter@{dc2\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a9ceac393328d0a6c09cccc8c38fa30a1}\label{bsoc_8c_a9ceac393328d0a6c09cccc8c38fa30a1}} 
\index{bsoc.c@{bsoc.c}!drive0\_filter@{drive0\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a9cf492c9b858a53133af1b29b9f68708}\label{bsoc_8c_a9cf492c9b858a53133af1b29b9f68708}} 
\index{bsoc.c@{bsoc.c}!drive1\_filter@{drive1\_filter}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_aa9b00e4f08c59d45a2baa05cc44191a2}\label{bsoc_8c_aa9b00e4f08c59d45a2baa05cc44191a2}} 
\index{bsoc.c@{bsoc.c}!error\_filter@{error\_filter}}
\index{error\_filter@{error\_filter}!bsoc.c@{bsoc.c}}
\doxysubsubsection{\texorpdfstring{error\_filter()}{error\_filter()}}
{\footnotesize\ttfamily static double error\+\_\+filter (\begin{DoxyParamCaption}\item[{const double}]{raw }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}


\begin{DoxyCode}{0}
\DoxyCodeLine{369 \{}
\DoxyCodeLine{370     \textcolor{keyword}{static} \textcolor{keywordtype}{double} accum = 0.0f;}
\DoxyCodeLine{371     accum = accum -\/ accum / \mbox{\hyperlink{bsoc_8c_abde809820d909d15f6f2b063208258ef}{L}}.\mbox{\hyperlink{structlocal__type_a11061b73094f46a2b995a06e14a25875}{coef}} + raw;}
\DoxyCodeLine{372     \textcolor{keywordflow}{return} accum / \mbox{\hyperlink{bsoc_8c_abde809820d909d15f6f2b063208258ef}{L}}.\mbox{\hyperlink{structlocal__type_a11061b73094f46a2b995a06e14a25875}{coef}};}
\DoxyCodeLine{373 \}}

\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_a8f6e0fd4594d467a89005d81038aa602}\label{bsoc_8c_a8f6e0fd4594d467a89005d81038aa602}} 
\index{bsoc.c@{bsoc.c}!get\_batc\_dev@{get\_batc\_dev}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_ade03000a21b56a5527367c81e7219c99}\label{bsoc_8c_ade03000a21b56a5527367c81e7219c99}} 
\index{bsoc.c@{bsoc.c}!gti\_test@{gti\_test}}
...
\mbox{\Hypertarget{bsoc_8c_abde809820d909d15f6f2b063208258ef}\label{bsoc_8c_abde809820d909d15f6f2b063208258ef}} 
\index{bsoc.c@{bsoc.c}!L@{L}}
\index{L@{L}!bsoc.c@{bsoc.c}}
\doxysubsubsection{\texorpdfstring{L}{L}}
{\footnotesize\ttfamily struct \mbox{\hyperlink{structlocal__type}{local\+\_\+type}} L\hspace{0.3cm}{\ttfamily [static]}}
...
\end{DoxyCode}
\mbox{\Hypertarget{bsoc_8c_ae6b57480d8cda466cfc65b9bfc47b255}\label{bsoc_8c_ae6b57480d8cda466cfc65b9bfc47b255}} 
\index{bsoc.c@{bsoc.c}!mqtt\_name@{mqtt\_name}}
\index{mqtt\_name@{mqtt\_name}!bsoc.c@{bsoc.c}}
\doxysubsubsection{\texorpdfstring{mqtt\_name}{mqtt\_name}}
{\footnotesize\ttfamily const char$\ast$ mqtt\+\_\+name\mbox{[}\mbox{\hyperlink{energy_8h_a4798b70da5e09a128bfc682db0b65072ab183b38bd716ecf9405c4546e3bd6870}{V\+\_\+\+DLAST}}\mbox{]}}
